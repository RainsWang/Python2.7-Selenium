...
class NewtonMethodWholelossHourVoltCalcResult:
    def __init__(self,driver):
        #驱动
        self.driver=driver
        #获取页面元素
        self.ProjectFilePath=GetProjectFilePath()
        self.Page_object_file=open(self.ProjectFilePath+"\\Page_object\\Data\\NewtonMethodWholelossHourVoltCalcResult.yaml")
        self.Page_Data=yaml.load(self.Page_object_file)
        self.Data=self.Page_Data['NewtonMethodWholelossHourVoltCalcResult']
        ...
        #输电网分压线损表-整点xpath
        self.WholelossHourVoltCalcResult_Xpath = self.Data['WholelossHourVoltCalcResult_Xpath']
        #报表iframe的ID
        self.WholelossCalcResultIframe_ID = self.Data['WholelossHourVoltCalcResulIframe_ID']
    ...
    def NewtonMethodWholelossHourVoltCalcResult_Fun(self,*args):
        #点击理论线损
        ...
        time.sleep(1)
        #点击分压线损表
        self.driver.find_element_by_xpath(self.WholelossHourVoltCalcResult_Xpath).click()
        time.sleep(5)
        ...
        time.sleep(5)
        self.data_file=u'C:\\Users\\'+GetUsername()+ u'\\Downloads\\全网分电压损耗报表（小时）.xls'
...
if __name__ == '__main__':
    ...
    time.sleep(5)
    Func=NewtonMethodWholelossHourVoltCalcResult(driver)
    TryReturn = Func.NewtonMethodWholelossHourVoltCalcResult_Fun()
    time.sleep(10)
    driver.quit()