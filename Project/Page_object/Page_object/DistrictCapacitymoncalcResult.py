...
class DistrictCapacitymoncalcResult:
    ...
    def DistrictCapacitymoncalcResult_Fun(self):
        '''400V月电量法计算结果验证'''
        #点击理论线损
...
if __name__=="__main__":
    ...
    Try1=DistrictCapacitymoncalcResult(driver)
    Try1.DistrictCapacitymoncalcResult_Fun()
    time.sleep(10)
    driver.quit()
