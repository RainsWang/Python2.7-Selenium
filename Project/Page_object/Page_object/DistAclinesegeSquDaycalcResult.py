...
class DistAclinesegeSquDaycalcResult:
    def __init__(self,driver):
        '''配线日均方根电流法导线损耗表链接页面结果验证'''
    ...
    def DistAclinesegeSquDaycalcResult_Fun(self):
        '''配线日均方根电流法导线损耗表链接页面结果验证'''
        #点击理论线损计算
...
if __name__=="__main__":
    ...
    Try1=DistAclinesegeSquDaycalcResult(driver)
    Try1.DistAclinesegeSquDaycalcResult_Fun()
    time.sleep(10)
    driver.quit()