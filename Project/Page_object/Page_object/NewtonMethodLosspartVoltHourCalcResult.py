...
class NewtonMethodLosspartVoltHourCalcResult:
    def __init__(self,driver):
        #驱动
        self.driver=driver
        #获取页面元素
        self.ProjectFilePath=GetProjectFilePath()
        self.Page_object_file=open(self.ProjectFilePath+"\\Page_object\\Data\\NewtonMethodLosspartVoltHourCalcResult.yaml")
        self.Page_Data=yaml.load(self.Page_object_file)
        self.Data=self.Page_Data['NewtonMethodLosspartVoltHourCalcResult']
        ...
        #分片分压线损表-整点xpath
        self.LossPartVoltResult_Xpath = self.Data['LossPartVoltResult_Xpath']
        #报表iframe的ID
        self.LossPartVoltResultIframe_ID = self.Data['LossPartVoltResultIframe_ID']
    ...
    def NewtonMethodLosspartVoltHourCalcResult_Fun(self,*args):
        ...
        time.sleep(1)
        #点击分片分压线损表
        self.driver.find_element_by_xpath(self.LossPartVoltResult_Xpath).click()
        time.sleep(5)
        ...
        time.sleep(5)
        self.data_file=u'C:\\Users\\'+GetUsername()+ u'\\Downloads\\全网分片分压线损报表（小时）.xls'
...
if __name__ == '__main__':
    ...
    time.sleep(5)
    Func=NewtonMethodLosspartVoltHourCalcResult(driver)
    TryReturn = Func.NewtonMethodLosspartVoltHourCalcResult_Fun()
    time.sleep(10)
    driver.quit()