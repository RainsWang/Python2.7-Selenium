...
class NewtonMethodTransAnalysisDayResult:
    def __init__(self,driver):
        ...
        self.Page_object_file=open(self.ProjectFilePath+"\\Page_object\\Data\\NewtonMethodTransAnalysisDayResult.yaml")
    ...
    def NewtonMethodTransAnalysisDayResult_Fun(self,*args):
        ...
        time.sleep(5)
        self.data_file=u'C:\\Users\\'+GetUsername()+ u'\\Downloads\\输电网变压器经济运行（日）.xls'
...
if __name__ == '__main__':
    ...
    time.sleep(5)
    Func=NewtonMethodTransAnalysisDayResult(driver)
    TryReturn = Func.NewtonMethodTransAnalysisDayResult_Fun()
    time.sleep(10)
    driver.quit()