...
class DistTransformerEleQuaMonCalResult:
    def __init__(self,driver):
        '''导线损耗表链接页面结果验证'''
        #self.driver=webdriver.Chrome()
        self.driver=driver
        self.ProjectFilePath=GetProjectFilePath()
        self.Page_object_data_file=open(self.ProjectFilePath+"\Page_object\Data\DistTransformerEleQuaMonCalResult.yaml")
        self.Page_Data=yaml.load(self.Page_object_data_file)
        self.Page_object_data_file.close()
        self.Data=self.Page_Data['DistTransformerEleQuaMonCalResult']
        ...
        ##点击月报表
        self.TheoreticalLineloss620kVMonth_Xpath=self.Data['TheoreticalLineloss620kVMonth_Xpath']
        #点击配电线路线损表
    ...
    def DistTransformerEleQuaMonCalResult_Fun(self):
        '''导线损耗表链接页面结果验证'''
        #点击理论线损计算
        ...
        time.sleep(10)
        self.data_path= u'C:\\Users\\'+GetUsername()+ u'\\Downloads\\配电变压器损耗表报表（月）.xls'
...
if __name__=="__main__":
    ...
    Try1=DistTransformerEleQuaMonCalResult(driver)
    Try1.DistTransformerEleQuaMonCalResult_Fun()
    time.sleep(10)
    driver.quit()
