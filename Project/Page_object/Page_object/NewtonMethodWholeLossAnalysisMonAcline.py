...
class NewtonMethodWholeLossAnalysisMonAcline:
    def __init__(self,driver):
        #驱动
        self.driver=driver
        #获取页面元素
        self.ProjectFilePath=GetProjectFilePath()
        self.Page_object_file=open(self.ProjectFilePath+"\\Page_object\\Data\\NewtonMethodWholeLossAnalysisMonAcline.yaml")
        self.Page_Data=yaml.load(self.Page_object_file)
        self.Data=self.Page_Data['NewtonMethodWholeLossAnalysisMonAcline']
    ...
    def NewtonMethodWholeLossAnalysisMonAcline_Fun(self,*args):
        #点击线损分析
        ...
        time.sleep(3)
        #点击导线追溯链接
        self.driver.find_element_by_xpath(self.Acline_xpath).click()
        time.sleep(5)
        self.driver.switch_to.parent_frame()
        #切换Iframe
        self.driver.switch_to_frame(self.AclineIframe_ID)
        #点击导出
        self.driver.find_element_by_id(self.Export_ID).click()
        time.sleep(3)
        self.data_file=u'C:\\Users\\'+GetUsername()+ u'\\Downloads\\输电网高损线路分析（月）.xls'
...
if __name__ == '__main__':
    ...
    time.sleep(5)
    Func=NewtonMethodWholeLossAnalysisMonAcline(driver)
    TryReturn = Func.NewtonMethodWholeLossAnalysisMonAcline_Fun()
    time.sleep(10)
    driver.quit()