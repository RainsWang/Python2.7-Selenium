...
class NewtonMethodWholeLossAnalysisDayTrans:
    def __init__(self,driver):
        #驱动
        self.driver=driver
        #获取页面元素
        self.ProjectFilePath=GetProjectFilePath()
        self.Page_object_file=open(self.ProjectFilePath+"\\Page_object\\Data\\NewtonMethodWholeLossAnalysisDayTrans.yaml")
        self.Page_Data=yaml.load(self.Page_object_file)
        self.Data=self.Page_Data['NewtonMethodWholeLossAnalysisDayTrans']
...
if __name__ == '__main__':
    ...
    time.sleep(5)
    Func=NewtonMethodWholeLossAnalysisDayTrans(driver)
    TryReturn = Func.NewtonMethodWholeLossAnalysisDayTrans_Fun()
    time.sleep(10)
    driver.quit()