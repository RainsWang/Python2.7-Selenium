...
class DistributionlinePieSComDay:
    ...
    def DistributionlinePieSComDay_Fun(self):
        '''配电线路线损率分段单位追溯统计结果核对'''
        #点击线损分析
        ...
        time.sleep(5)
        self.data_file=u"C:\\Users\\Admin\Downloads\配电线路线损率分段统计表样二(日).xlsx"
...
if __name__=="__main__":
    ...
    Try1=DistributionlinePieSComDay(driver)
    Try1.DistributionlinePieSComDay_Fun()
    time.sleep(10)
    driver.quit()