...
class NewtonMethodWholeLossAnalysisMonTrans:
    def __init__(self,driver):
        #驱动
        self.driver=driver
        #获取页面元素
        self.ProjectFilePath=GetProjectFilePath()
        self.Page_object_file=open(self.ProjectFilePath+"\\Page_object\\Data\\NewtonMethodWholeLossAnalysisMonTrans.yaml")
    ...
    def NewtonMethodWholeLossAnalysisMonTrans_Fun(self,*args):
        #点击线损分析
        ...
        time.sleep(3)
        self.data_file=u'C:\\Users\\'+GetUsername()+ u'\\Downloads\\输电网高损变压器分析（月）.xls'
...
if __name__ == '__main__':
    ...
    time.sleep(5)
    Func=NewtonMethodWholeLossAnalysisMonTrans(driver)
    TryReturn = Func.NewtonMethodWholeLossAnalysisMonTrans_Fun()
    time.sleep(10)
    driver.quit()