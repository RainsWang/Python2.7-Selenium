...
class NewtonMethodTransAnalysisMonResult:
    def __init__(self,driver):
        #驱动
        self.driver=driver
        #获取页面元素
        self.ProjectFilePath=GetProjectFilePath()
        self.Page_object_file=open(self.ProjectFilePath+"\\Page_object\\Data\\NewtonMethodTransAnalysisMonResult.yaml")
        self.Page_Data=yaml.load(self.Page_object_file)
        self.Data=self.Page_Data['NewtonMethodTransAnalysisMonResult']
    ...
    def NewtonMethodTransAnalysisMonResult_Fun(self,*args):
        #点击线损分析
        ...
        time.sleep(5)
        self.data_file=u'C:\\Users\\'+GetUsername()+ u'\\Downloads\\输电网变压器经济运行（月）.xls'
...
if __name__ == '__main__':
    ...
    time.sleep(5)
    Func=NewtonMethodTransAnalysisMonResult(driver)
    TryReturn = Func.NewtonMethodTransAnalysisMonResult_Fun()
    time.sleep(10)
    driver.quit()