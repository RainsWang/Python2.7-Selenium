...
class NewtonMethodSubstationDayCalcResult:
    def __init__(self,driver):
        #驱动
        self.driver=driver
        #获取页面元素
        self.ProjectFilePath=GetProjectFilePath()
        self.Page_object_file=open(self.ProjectFilePath+"\\Page_object\\Data\\NewtonMethodSubstationDayCalcResult.yaml")
        self.Page_Data=yaml.load(self.Page_object_file)
        self.Data=self.Page_Data['NewtonMethodSubstationDayCalcResult']
    ...
    def NewtonMethodSubstationDayCalcResult_Fun(self,*args):
        #点击理论线损
        ...
        time.sleep(5)
        self.data_file=u'C:\\Users\\'+GetUsername()+ u'\\Downloads\\变电站损耗报表（日）.xls'
...
if __name__ == '__main__':
    ...
    time.sleep(5)
    Func=NewtonMethodSubstationDayCalcResult(driver)
    TryReturn = Func.NewtonMethodSubstationDayCalcResult_Fun()
    time.sleep(10)
    driver.quit()