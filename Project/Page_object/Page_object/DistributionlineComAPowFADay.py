...
class DistributionlineComAPowFADay:
    def __init__(self,driver):
        '''功率因数追溯结果报表核对'''
        self.driver=driver
        self.ProjectFilePath=GetProjectFilePath()
        self.Page_object_data_file=open(self.ProjectFilePath+"\Page_object\Data\DistributionlineComAPowFADay.yaml")
        self.Page_data=yaml.load(self.Page_object_data_file)
        self.Page_object_data_file.close()
        self.Data=self.Page_data['DistributionlineComAPowFADay']
        ...
        #点击功率因数追溯
        self.PowerFactor_Xpath=self.Data['PowerFactor_Xpath']
        #切换到配电线路功率因数分析报表（日）frame中
        self.PowerFactor_frame=self.Data['PowerFactor_frame']
        #点击功率因数追溯页面的导出
        self.Export_Class=self.Data['Export_Class']

    def DistributionlineComAPowFADay_Fun(self):
        '''功率因数追溯结果报表核对'''
        #点击线损分析
        ...
        time.sleep(7)
        #点击功率因数追溯
        self.driver.find_element_by_xpath(self.PowerFactor_Xpath).click()
        time.sleep(3)
        #跳出配电线路线损分析的frame
        self.driver.switch_to.default_content()
        self.driver.implicitly_wait(10)
        #切换到配电线路功率因数分析报表（日）frame中
        self.driver.switch_to.frame(self.PowerFactor_frame)
        self.driver.implicitly_wait(7)
        #点击功率因数追溯页面的导出
        self.driver.find_element_by_class_name(self.Export_Class).click()
        time.sleep(5)
        self.data_file=u"C:\\Users\\Admin\Downloads\配电线路功率因数分析报表(日).xls"
...
if __name__=="__main__":
    ...
    Try1=DistributionlineComAPowFADay(driver)
    Try1.DistributionlineComAPowFADay_Fun()
    time.sleep(10)
    driver.quit()
