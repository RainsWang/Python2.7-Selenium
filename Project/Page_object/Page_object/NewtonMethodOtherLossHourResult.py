...
class NewtonMethodOtherLossHourResult:
    def __init__(self,driver):
        ...
        self.Page_object_file=open(self.ProjectFilePath+"\\Page_object\\Data\\NewtonMethodOtherLossHourResult.yaml")
...
if __name__ == '__main__':
    ...
    time.sleep(5)
    Func=NewtonMethodOtherLossHourResult(driver)
    TryReturn = Func.NewtonMethodOtherLossHourResult_Fun()
    time.sleep(10)
    driver.quit()