...
class DistributionlineComAStDay:
    def __init__(self,driver):
        ...
        self.Page_object_data_file=open(self.ProjectFilePath+"\Page_object\Data\DistributionlineComAStDay.yaml")
...
if __name__=="__main__":
    ...
    Try1=DistributionlineComAStDay(driver)
    Try1.DistributionlineComAStDay_Fun()
    time.sleep(10)
    driver.quit()
