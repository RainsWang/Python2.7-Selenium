...
class DistributionlineEconomicTranDay:
    def __init__(self,driver):
        ...
        self.Page_object_data_file=open(self.ProjectPathFile+"\Page_object\Data\DistributionlineEconomicTranDay.yaml")
...
if __name__=="__main__":
    ...
    Try1=DistributionlineEconomicTranDay(driver)
    Try1.DistributionlineEconomicTranDay_Fun()
    time.sleep(10)
    driver.quit()