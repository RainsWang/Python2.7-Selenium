...
class NewtonMethodTransAnalysisDayRetrospect:
    def __init__(self,driver):
        #驱动
        self.driver=driver
        #获取页面元素
        self.ProjectFilePath=GetProjectFilePath()
        self.Page_object_file=open(self.ProjectFilePath+"\\Page_object\\Data\\NewtonMethodTransAnalysisDayRetrospect.yaml")
    ...
    def NewtonMethodTransAnalysisDayRetrospect_Fun(self,*args):
        #点击线损分析
        ...
        time.sleep(5)
        self.data_file=u'C:\\Users\\'+GetUsername()+ u'\\Downloads\\输电网变压器损耗明细（日）-重载变.xls'
...
if __name__ == '__main__':
    ...
    time.sleep(5)
    Func=NewtonMethodTransAnalysisDayRetrospect(driver)
    TryReturn = Func.NewtonMethodTransAnalysisDayRetrospect_Fun()
    time.sleep(10)
    driver.quit()