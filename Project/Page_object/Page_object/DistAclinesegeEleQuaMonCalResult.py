...
class DistAclinesegeEleQuaMonCalResult:
    def __init__(self,driver):
        ...
        self.Page_object_data_file=open(self.ProjectFilePath+"\Page_object\Data\DistAclinesegeEleQuaMonCalResult.yaml")
    ...
    def DistAclinesegeEleQuaMonCalResult_Fun(self):
        ...
        time.sleep(10)
        self.data_path= u'C:\\Users\\'+GetUsername()+ u'\\Downloads\\配电线路导线损耗报表（月）.xls'
...
if __name__=="__main__":
    ...
    Try1=DistAclinesegeEleQuaMonCalResult(driver)
    Try1.DistAclinesegeEleQuaMonCalResult_Fun()
    time.sleep(10)
    driver.quit()