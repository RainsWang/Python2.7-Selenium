...
class NewtonMethodWholeLossAnalysisDayAcline:
    def __init__(self,driver):
        #驱动
        self.driver=driver
        #获取页面元素
        self.ProjectFilePath=GetProjectFilePath()
        self.Page_object_file=open(self.ProjectFilePath+"\\Page_object\\Data\\NewtonMethodWholeLossAnalysisDayAcline.yaml")
    ...
    def NewtonMethodWholeLossAnalysisDayAcline_Fun(self,*args):
        #点击线损分析
        ...
        time.sleep(5)
        self.data_file=u'C:\\Users\\'+GetUsername()+ u'\\Downloads\\输电网高损线路分析(日).xls'
...
if __name__ == '__main__':
    ...
    time.sleep(5)
    Func=NewtonMethodWholeLossAnalysisDayAcline(driver)
    TryReturn = Func.NewtonMethodWholeLossAnalysisDayAcline_Fun()
    time.sleep(10)
    driver.quit()