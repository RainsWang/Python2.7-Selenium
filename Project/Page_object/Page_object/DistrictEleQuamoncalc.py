...
class DistrictEleQuamoncalc:
    ...
    def __init__(self, driver):
        ...
        self.Page_object_data_file = open(self.ProjectFilePath + "\Page_object\Data\DistrictEleQuamoncalc.yaml")
        self.Page_Data = yaml.load(self.Page_object_data_file)
        self.Page_object_data_file.close()
        self.Data = self.Page_Data['DistrictEleQuamoncalc']
        ...
        # 计算方法：电量法
        self.EleQuamoncalc_id = self.Data['EleQuamoncalc_id']
        # 选择月计算
    ...
    def DistrictEleQuamoncalc_Fun(self):
        # 台区月电量法计算#
        # 点击理论线损计算#
        ...
        time.sleep(2)
        self.driver.find_element_by_id(self.EleQuamoncalc_id).click()
        time.sleep(2)
...
if __name__=="__main__":
    ...
    Try1=DistrictEleQuamoncalc(driver)
    Try1.DistrictEleQuamoncalc_Fun()
    time.sleep(10)
    driver.quit()