...
时间          ：2018/12/27 16:40
当前项目名称  ：Auto
功能          ：配电线路综合分析日报表-配线追溯（配电线路综合分析）核对
-------------------------------------漂亮的分割线----------------------------------------------'''
import time
...
try:
    ...
    time.sleep(5)
    #点击配电线路追溯
    driver.find_element_by_xpath("//table/tbody/tr[2]/td[6]/div/a/div/span").click()
    time.sleep(5)
    #跳出配电线路线损分析的frame
    driver.switch_to.default_content()
    driver.implicitly_wait(10)
    #切换到配电线路线损组成分析（日）frame中
    driver.switch_to.frame('iframe_4028801b3ef2fda9013ef479fbc00394')
    time.sleep(5)
    #点击导出按钮
    driver.find_element_by_class_name('x-btn-inner').click()
    time.sleep(3)
