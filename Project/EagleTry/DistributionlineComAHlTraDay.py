...
try:
    ...
    time.sleep(5)
    #点击变压器损耗电量追溯
    driver.find_element_by_xpath("//table/tbody/tr[2]/td[25]/div/a/div/span").click()
    time.sleep(5)
    #跳出配电线路线损分析的frame
    driver.switch_to.default_content()
    driver.implicitly_wait(10)
    #切换到配电网高损配变分析报表frame中
    driver.switch_to.frame('iframe_4028801b3ec1febd013ec506ac3a0104')
    time.sleep(5)
    #点击导出按钮
    driver.find_element_by_id('button-1057-btnIconEl').click()
    time.sleep(3)
except Exception,e:
    print(e)
finally:
