...
try:
    ...
    time.sleep(7)
    #点击单位追溯
    #driver.find_element_by_xpath("//div/div[2]/div/div[2]div[3]/div[2]/div/div/a").click()
    #driver.find_element_by_css_selector("div#_z_69-real>a").click()
    driver.find_element_by_link_text(u'计算结果图形').click()
    time.sleep(3)
    driver.switch_to.parent_frame()  ##跳出结果中的的frame
    time.sleep(5)
    ...
    time.sleep(5)
    #点击导出
    driver.find_element_by_id('4028801b4033ffd5014037f37f0e007e-btnInnerEl').click()
    time.sleep(5)
except Exception,e:
    print(e)
finally:
